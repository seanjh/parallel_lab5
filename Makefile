...
_CONVOLVE_TEST_OBJ = Array2d.o convolve.o convolve_test.o Image.o Stencil.o PNM.o
CONVOLVE_TEST_OBJ = $(patsubst %,$(ODIR)/%,$(_CONVOLVE_TEST_OBJ))

_FILTER_IMAGE_OBJ = Array2d.o convolve.o filter_image.o Image.o Stencil.o PNM.o
